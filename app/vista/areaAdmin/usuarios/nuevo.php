                        ...
                        <div class="row">
                            <div class="col-lg-11">
                                <div class="well bs-component">
                                    <form class="form-horizontal" method="POST" action="http://localhost/proyecto_final_ts1/?c=admin&a=GuardarUsuario&n=<?= $n ?>&rol=<?= $rol ?>&id=<?= $id ?>">
                                        <fieldset>
                                            <legend><?= $titulo ?></legend>
                                            <div class="form-group">
                                                <input class="form-control" type="hidden"
                                                    name="idU" id="idU" value="<?= $u->getId() ?>">
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="nombres">Nombres</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="nombres" name="nombres" type="text" placeholder="Nombres" required value="<?= $u->getNombres() ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="apellidos">Apellidos</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="apellidos" name="apellidos" type="text" placeholder="Apellidos" required value="<?= $u->getApellidos() ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="telefono">Teléfono</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="telefono" name="telefono" type="number" placeholder="Teléfono" required value="<?= $u->getTelefono() ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="edad">Edad</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="edad" name="edad" type="number" placeholder="Edad" required value="<?= $u->getEdad() ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <select class="form-control" id="rol" name="rol" required>
                                                        ...
                                                        <option value=2 <?= $u->getRol() === 2 ? 'selected' : '' ?>>Publicador</option>
                                                        <option value=3 <?= $u->getRol() === 3 ? 'selected' : '' ?>>Usuario registrado</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-10">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="permiso_publicar" name="permiso_publicar" <?= $u->getPermisoPublicar() ? 'checked' : '' ?>>
                                                            <label class="form-check-label ml-4" for="permiso_publicar">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-15 col-lg-offset-4">
                                                    <button class="btn btn-default" type="button" onclick="window.location.href='http://localhost/proyecto_final_ts1/?c=admin&a=Usuarios&n=<?= $n ?>&rol=<?= $rol ?>&id=<?= $id ?>'">Cancelar</button>
